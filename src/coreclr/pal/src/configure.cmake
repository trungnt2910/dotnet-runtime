...
elseif(NOT CLR_CMAKE_TARGET_FREEBSD AND NOT CLR_CMAKE_TARGET_NETBSD AND NOT CLR_CMAKE_TARGET_HAIKU)
...
if (CLR_CMAKE_TARGET_HAIKU)
  set(PTHREAD_LIBRARY root)
elseif (HAVE_LIBPTHREAD)
...
if(NOT CLR_CMAKE_TARGET_HAIKU)
    ...
    check_struct_has_member ("ucontext_t" uc_mcontext.gregs[0] signal.h HAVE_GREGSET_T)
    check_struct_has_member ("ucontext_t" uc_mcontext.__gregs[0] signalt.h HAVE___GREGSET_T)
    check_struct_has_member ("ucontext_t" uc_mcontext.fpregs->__glibc_reserved1[0] signal.h HAVE_FPSTATE_GLIBC_RESERVED1)
endif()
